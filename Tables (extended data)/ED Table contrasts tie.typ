...
#figure(
    gridx(
        ...
        cellx()[-0.009 \ (-0.049, 0.032) \ 0.6641],
        hlinex(start: 1, stroke: 0.01em),
        cellx()[7],
        cellx()[Degree (mean)],
        cellx()[15.99 > 1.0],
    ...
    caption: flex-caption(
        [Contrasts for tie characteristics. Each accuracy measure represents the difference between the predicted value for each level of the contrast. 95% confidence intervals are presented in parentheses, and rounded to 3 digits. P-values are rounded to 4 digits.],
