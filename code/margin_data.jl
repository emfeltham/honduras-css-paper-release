# margin_data
# julia --threads=12 --project="." "code/margin data.jl" > "output/margin data.jl.txt"
...
# because the above runs long, you may want to separate this execution
# into stages
# margindict = load_object("objects/base1_tie2_margins.jld2");

pbs = (
    tpr = load_object("objects/base1_pb_10K_tpr_tie_2.jld2"),
    fpr = load_object("objects/base1_pb_10K_fpr_tie_2.jld2")
);
...
# Calcualte bootstrap confidence intervals on the J statistic
altermargins_bs!(
    margindict, bm, βset, invlink, K; bivar = true
)

save_object("objects/base1_tie2_margins_bs.jld2", margindict);
