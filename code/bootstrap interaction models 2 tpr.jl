...
# ~/.juliaup/bin/julia --threads=60 "--sysimage=JuliaSysimage_plot_mod.so" --project="." "honduras-css-paper/code/bootstrap interaction models 2 tpr.jl" > "output_mi2_pb_age2_tpr.txt"
...
save_object("interaction models/interaction_2_pb_age2_tpr.jld2", pbt)
