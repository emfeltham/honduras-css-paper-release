# tie_contrasts.jl
# julia --threads=32 --project="." "honduras-css-paper/code/tie_contrasts_1.jl" > "output_tie_contrasts_1.txt"
...
save_object("interaction models/tie_contrasts_1.jld2", emsd);
