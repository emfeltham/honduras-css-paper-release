...
# julia --threads=32 --project="." "honduras-css-paper/code/bootstrap base model fpr.jl" > "output_main_pb_fpr.txt"
...
save_object("interaction models/main_2_pb_1K_fpr.jld2", pbf)
