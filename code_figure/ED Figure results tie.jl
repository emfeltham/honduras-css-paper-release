# ED Figure results tie.jl
#=
Determinants of tie accuracy.
=#
...
#%%
fg = Figure()
make_figure4_alt!(fg, md, transforms)
resize!(fg, 1000 * 2, 400 * 4)
resize_to_layout!(fg)
...
#%%
let fg = fg
	filename = "honduras-css-paper/Figures (extended data)/ED Figure results tie"
