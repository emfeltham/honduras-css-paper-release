# relatedness model data

include("analysis_preamble.jl")

bm = load_object("objects/main_kinship.jld2")

pbs = (
    tpr = load_object("objects/kinship_pbs_tpr.jld2"),
    fpr = load_object("objects/kinship_pbs_fpr.jld2"),
);
...
save_object(
    "objects/base1_tie2_relatedness_margins_bs.jld2", margindict
);

# margindict = load_object(
#     "objects/base1_tie2_relatedness_margins_bs.jld2"
# );
...
save_object(
    "objects/base1_tie2_relatedness_margins_bs_out.jld2",
    margindict
)
